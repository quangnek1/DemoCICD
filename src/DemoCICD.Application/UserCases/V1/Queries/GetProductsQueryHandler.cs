...
public sealed class GetProductsQueryHandler : IQueryHandler<Query.GetProductQuery, PagedResult<Response.ProductResponse>>
{
    private readonly IRepositoryBase<Product, Guid> _productRepository;
    private readonly IMapper _mapper;
    private readonly ApplicationDbContext _context;

    public GetProductsQueryHandler(IRepositoryBase<Product, Guid> productRepository,
